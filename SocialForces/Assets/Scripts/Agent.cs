...
public class Agent : MonoBehaviour
{
    ...
    private Vector3 CalculateAgentForce()
    {
        ...
        foreach (var n in perceivedNeighbors)
        {
            ...
            var radiusDiff = (radius + neighbor.radius) - Vector3.Distance(transform.position, n.transform.position);
            ...
            agentForce = proximityForce+repulsionForce+slidingForce;
        }
